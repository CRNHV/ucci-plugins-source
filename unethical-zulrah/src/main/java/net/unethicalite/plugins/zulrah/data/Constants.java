...
public class Constants
{
    ...
    public static final List<String> LOOT_TABLE = Arrays.asList("Zulrah's scales", "Tanzanite fang", "Magic fang", "Serpentine visage",
            ...
            "Dwarf weed seed", "Torstol seed", "Crystal seed", "Dragon bones", "Coconut", "Grapes", "Zul-andra teleport",
            ...
            "Nature rune", "Rune arrow", "Adamant javelin", "Rune javelin",
            "Tanzanite mutagen", "Magma mutagen", "Jar of swamp", "Pet snakeling", "Death rune", "Chaos rune", "Spirit seed");
    ...
    public static final String FEROX_ENCLAVE = "Ferox Enclave";
    public static final String RANGE_POTION = "Ranging potion";
